...
#ifndef H_LUSOCOIN_SCRIPT
#define H_LUSOCOIN_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CLusocoinAddress
 */
...
public:
    ...
    // Pre-version-0.6, Lusocoin always counted CHECKMULTISIGs
