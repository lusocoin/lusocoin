...
{
    BOOST_CHECK(TestSplitHost("www.lusocoin.org", "www.lusocoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.lusocoin.org]", "www.lusocoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.lusocoin.org:80", "www.lusocoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.lusocoin.org]:80", "www.lusocoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:8444", "127.0.0.1", 8444));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:8444", "127.0.0.1", 8444));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:8444", "::ffff:127.0.0.1", 8444));
    BOOST_CHECK(TestSplitHost("[::]:8444", "::", 8444));
    BOOST_CHECK(TestSplitHost("::8444", "::8444", -1));
    BOOST_CHECK(TestSplitHost(":8444", "", 8444));
    BOOST_CHECK(TestSplitHost("[]:8444", "", 8444));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:8444", "127.0.0.1:8444"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:8444", "[::]:8444"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
